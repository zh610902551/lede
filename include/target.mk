...
luci-app-filetransfer luci-app-vsftpd luci-app-ssr-plus luci-app-guest-wifi luci-app-cpulimit luci-app-ttyd luci-app-smartinfo luci-app-zerotier luci-app-syncdial luci-app-wifischedule \
