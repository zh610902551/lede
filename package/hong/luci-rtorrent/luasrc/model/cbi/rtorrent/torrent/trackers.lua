...
t:option(DummyValue, "scrape_downloaded", "D"):tooltip(translate("Downloaded"))
t:option(DummyValue, "scrape_complete", "S"):tooltip(translate("Seeders"))
t:option(DummyValue, "scrape_incomplete", "L"):tooltip(translate("Leechers"))
t:option(DummyValue, "scrape_time_last", "Updated"):tooltip(translate("Last update time")).rawhtml = true
