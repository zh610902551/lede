...
t:option(DummyValue, "chunks_percent", translate("Done")):tooltip(translate("Download done percent")).rawhtml = true
prio = t:option(ListValue, "priority", translate("Priority")):tooltip(translate("Rotate priority"))
