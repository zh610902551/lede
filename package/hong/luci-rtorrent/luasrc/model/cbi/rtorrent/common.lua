...
function try_init_https()
    https = require "ssl.https"
    ssl = require "ssl"
end

pcall(try_init_https)
...
local COOKIES_FILE = "/etc/rtorrent/cookies.txt"
...
--[[function get_admin_pages()
	return {
		{ name = "rTorrent", link = dispatcher.build_url("admin/nas/rtorrent_config") },
		{ name = "RSS", link = dispatcher.build_url("admin/nas/rtorrent_config_rss") }
	}
end]]--
