...
t:option(DummyValue, "peers_accounted", "&uarr;"):tooltip(translate("Seeder count")).rawhtml = true
t:option(DummyValue, "peers_complete", "&darr;"):tooltip(translate("Leecher count")).rawhtml = true
t:option(DummyValue, "down_rate", "Down<br />Speed"):tooltip(translate("Download speed in kb/s")).rawhtml = true
t:option(DummyValue, "up_rate", "Up<br />Speed"):tooltip(translate("Upload speed in kb/s")).rawhtml = true
t:option(DummyValue, "ratio", "Ratio"):tooltip(translate("Download/upload ratio")).rawhtml = true
t:option(DummyValue, "eta", "ETA"):tooltip(translate("Estimated Time of Arrival")).rawhtml = true
...
add = s:option(Button, "add", translate("add"))
add.template = "rtorrent/button"
add.inputstyle = "apply"
