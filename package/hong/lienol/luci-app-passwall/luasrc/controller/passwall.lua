...
function index()
    ...
    entry({"admin", "services", "passwall", "node_list"},
    ...
    entry({"admin", "services", "passwall", "other"}, cbi("passwall/other"),
    ...
    entry({"admin", "services", "passwall", "rule_list"}, cbi("passwall/rule_list"),
